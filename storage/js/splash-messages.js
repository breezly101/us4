const phrases = [
    ...
    `this site is educational trust`,
    `hi`,
    `i forgot to mute`,
    ...
    `chromebooks suck`,
    `tabs within tabs`,
    `this isn’t what the teacher wanted`,
